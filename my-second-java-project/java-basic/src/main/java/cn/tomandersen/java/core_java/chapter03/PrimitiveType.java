...
public class PrimitiveType {
    ...
    static void integerDemo() {
        ...
        var c = 1f;
        var d = 0b1001;
        System.out.println(getClassName(a) + ": " + a);
        System.out.println(getClassName(a) + ": " + b);
        System.out.println(getClassName(a) + ": " + c);
        System.out.println(getClassName(a) + ": " + d);
    }
...
//        }
    ...
    static void typeCastDemo() {
        ...
        System.out.println(getClassName(1.0d + 2) + ": " + (1.0d + 2));
        // 2. 否则, 如果其中一个是 float, 另外一个会被强制转换为 float
        System.out.println(getClassName(1.0f + 2) + ": " + (1.0f + 2));
        // 在整型强制转换为浮点型时, 如果超出浮点型的可表示范围, 则会丢失精度, 如 int 转换为 float
        System.out.println(getClassName(1.0f + 123456789) + ": " + (1.0f + 123456789));
        // 3. 否则, 如果其中一个操作数是 long, 另外一个会被强制转换为 long 类型
        System.out.println(getClassName(1L + 2) + ": " + (1L + 2));
        // 4. 否则, 两个操作数都会被强制转换为 int 类型
        System.out.println(getClassName(1 + 0b10) + ": " + (1 + 0b10));
    }
